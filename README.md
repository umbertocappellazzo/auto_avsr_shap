...
This repository contains the code to compute the audio/video SHAP contributions for the Auto-AVSR model. For more details, please refer to our [`paper`](https://arxiv.org/abs/2603.12046). 
